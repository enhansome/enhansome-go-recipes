...
### [⏫](#contents) :gift: Comment code coverage reports in pull request with [go-coverage-report](https://github.com/fgrosse/go-coverage-report) ⭐ 126 | 🐛 3 | 🌐 Go | 📅 2026-09-20
...
### [⏫](#contents) :gift: Manipulate coverage profiles with [gopherage](https://github.com/kubernetes/test-infra/blob/master/gopherage) ⭐ 4,023 | 🐛 130 | 🌐 Go | 📅 2026-09-20
...
### [⏫](#contents) Detect goroutine leaks with [goleak](https://github.com/uber-go/goleak) ⭐ 5,282 | 🐛 23 | 🌐 Go | 📅 2026-09-15
...
### [⏫](#contents) Decorate `go test` with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,720 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Get slowest tests with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,720 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Auto-Instrument skipping slowest tests with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,720 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Automatically re-run failed tests with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,720 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Make `JUnit` test report with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,720 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Report each subtest as its own case with [qualflare-go](https://github.com/Qualflare/qualflare-go) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-09-20
...
### [⏫](#contents) Perform Mutation Testing with [ooze](https://github.com/gtramontina/ooze) ⭐ 288 | 🐛 15 | 🌐 Go | 📅 2026-09-17
...
### [⏫](#contents) Perform Mutation Testing with [avito-tech/go-mutesting](https://github.com/avito-tech/go-mutesting) ⭐ 270 | 🐛 25 | 🌐 Go | 📅 2026-01-12

This is fork of [zimmski/go-mutesting](https://github.com/zimmski/go-mutesting) ⭐ 675 | 🐛 43 | 🌐 Go | 📅 2024-07-04. It has more mutators and latest updates. — [@vasiliyyudin](https://github.com/vasiliyyudin)
...
### [⏫](#contents) :gift: Perform Mutation Testing with [jonbaldie/go-mutesting](https://github.com/jonbaldie/go-mutesting) ⭐ 6 | 🐛 1 | 🌐 Go | 📅 2026-09-19
...
### [⏫](#contents) Perform Mutation Testing with [go-mutesting](https://github.com/zimmski/go-mutesting) ⭐ 675 | 🐛 43 | 🌐 Go | 📅 2024-07-04
...
### [⏫](#contents) Get go module libyear, number of releases, version delta with [go-libyear](https://github.com/nieomylnieja/go-libyear) ⭐ 42 | 🐛 6 | 🌐 Go | 📅 2026-09-20
...
### [⏫](#contents) Scrape licenses of upstream dependencies with [go-licenses](https://github.com/google/go-licenses) ⭐ 1,017 | 🐛 58 | 🌐 Go | 📅 2026-07-09
...
### [⏫](#contents) Explore dependencies graph interactively with [modview](https://github.com/bayraktugrul/modview) ⭐ 225 | 🐛 2 | 🌐 Go | 📅 2024-12-19
...
### [⏫](#contents) Enforce Go code architecture with [go-arch-lint](https://github.com/fe3dback/go-arch-lint) ⭐ 563 | 🐛 18 | 🌐 Go | 📅 2026-09-07
...
### [⏫](#contents) Make graph of function calls in package with [go-callvis](https://github.com/ofabry/go-callvis) ⭐ 6,519 | 🐛 73 | 🌐 Go | 📅 2026-03-30
...
### [⏫](#contents) Make D2 graph of architecture and dependencies with [go-arch-lint graph](https://github.com/fe3dback/go-arch-lint) ⭐ 563 | 🐛 18 | 🌐 Go | 📅 2026-09-07
...
Official Go team [encourages](https://github.com/golang/go/issues/20520) ⭐ 138,911 | 🐛 10,159 | 🌐 Go | 📅 2026-09-20 to run sequentially. However, in certain situations, such as lots of mocks, parallelization helps a lot, albeit, you should consider including your generated files in git. The solution below spawns multiple processes, each per pkg.
...
### [⏫](#contents) Generate data types from JSON Schema with [go-jsonschema](https://github.com/omissis/go-jsonschema) ⭐ 806 | 🐛 88 | 🌐 Go | 📅 2026-09-20
...
### [⏫](#contents) Generate Table Driven Tests with [gotests](https://github.com/cweill/gotests) ⭐ 5,334 | 🐛 39 | 🌐 Go | 📅 2025-10-30
...
### [⏫](#contents) Generate mocks with [mockgen](https://github.com/uber-go/mock) ⭐ 3,407 | 🐛 111 | 🌐 Go | 📅 2026-08-25
...
### [⏫](#contents) Generate decorator for interface with [gowrap](https://github.com/hexdigest/gowrap) ⭐ 1,339 | 🐛 21 | 🌐 Go | 📅 2026-09-02
...
### [⏫](#contents) Generate code from OpenAPI 3 specification with [oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) ⭐ 8,585 | 🐛 325 | 🌐 Go | 📅 2026-09-18
...
I found this in announcement [notice](https://github.com/golang/go/commit/2580d0e08d5e9f979b943758d3c49877fb2324cb) ⭐ 138,911 | 🐛 10,159 | 🌐 Go | 📅 2026-09-20 of Go 1.18 for changes to `interface{}` to `any`. This can be useful for other refactorings too.
...
### [⏫](#contents) Pretty print `panic` messages with [panicparse](https://github.com/maruel/panicparse) ⭐ 3,705 | 🐛 3 | 🌐 Go | 📅 2026-07-13
...
### [⏫](#contents) Transpile Go to Javascript with [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 13,184 | 🐛 189 | 🌐 Go | 📅 2026-08-20
...
### [⏫](#contents) View Go assembly interactively with [lensm](https://github.com/loov/lensm) ⭐ 3,687 | 🐛 3 | 🌐 Go | 📅 2026-08-25
...
### [⏫](#contents) View Go assembly with color annotation with [pat/disfunc](https://github.com/maruel/pat) ⭐ 12 | 🐛 0 | 🌐 Go | 📅 2023-08-29
...
### [⏫](#contents) Run alternative Go Playground with [goplay.tools](https://github.com/x1unix/go-playground) ⭐ 1,486 | 🐛 7 | 🌐 Go | 📅 2026-09-13
...
### [⏫](#contents) Run interactive Go kernels in Jupyter Notebook with [gophernotes](https://github.com/gopherdata/gophernotes) ⭐ 3,965 | 🐛 54 | 🌐 Go | 📅 2026-09-09
...
### [⏫](#contents) Run interactive Go interpreter with [yaegi](https://github.com/traefik/yaegi) ⭐ 8,397 | 🐛 186 | 🌐 Go | 📅 2026-02-09
...
### [⏫](#contents) Run Go function in shell with [gosh](https://github.com/nickwells/utilities/blob/master/gosh/_gosh.DOC.md) ⭐ 41 | 🐛 2 | 🌐 Go | 📅 2026-09-19
...
### [⏫](#contents) Auto-Instrument functions for DataDog with [orchestrion](https://github.com/DataDog/orchestrion) ⭐ 622 | 🐛 21 | 🌐 Go | 📅 2026-09-18
...
### [⏫](#contents) Continuous Profiling with [Pyroscope](https://github.com/grafana/pyroscope) ⭐ 11,666 | 🐛 411 | 🌐 Go | 📅 2026-09-18
...
### [⏫](#contents) Benchmark against git commit with [pat/ba](https://github.com/maruel/pat) ⭐ 12 | 🐛 0 | 🌐 Go | 📅 2023-08-29
...
* [Uber](https://github.com/uber-go/guide) ⭐ 17,715 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15
...
### [⏫](#contents) Detect escalated privileges in dependencies with [capslock](https://github.com/google/capslock) ⭐ 1,180 | 🐛 14 | 🌐 Go | 📅 2026-09-15
...
### [⏫](#contents) Run static analysis with [gosec](https://github.com/securego/gosec) ⭐ 8,948 | 🐛 8 | 🌐 Go | 📅 2026-09-17
...
### [⏫](#contents) Use Microsoft Go compiler with [microsoft/go](https://github.com/microsoft/go) ⭐ 431 | 🐛 128 | 🌐 Go | 📅 2026-09-18
...
### [⏫](#contents) Detect most common issues with [staticcheck](https://github.com/dominikh/go-tools) ⭐ 6,902 | 🐛 578 | 🌐 Go | 📅 2026-08-24
...
### [⏫](#contents) Detect common style, performance, and naming issues with [revive](https://github.com/mgechev/revive) ⭐ 5,554 | 🐛 73 | 🌐 Go | 📅 2026-09-17
...
### [⏫](#contents) Detect potential Nil panics with [nilaway](https://github.com/uber-go/nilaway) ⭐ 3,909 | 🐛 76 | 🌐 Go | 📅 2026-09-18
...
### [⏫](#contents) Detect most common issues with [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,069 | 🐛 153 | 🌐 Go | 📅 2026-09-20
...
### [⏫](#contents) Detect non-exhaustive switch and map with [exhaustive](https://github.com/nishanths/exhaustive) ⭐ 348 | 🐛 12 | 🌐 Go | 📅 2026-09-13
...
### [⏫](#contents) Detect structs with uninitialized fields with [go-exhaustruct](https://github.com/GaijinEntertainment/go-exhaustruct) ⭐ 207 | 🐛 6 | 🌐 Go | 📅 2026-09-04
...
### [⏫](#contents) Detect unnecessary type conversions with [unconvert](https://github.com/mdempsky/unconvert) ⭐ 388 | 🐛 9 | 🌐 Go | 📅 2026-08-16
...
### [⏫](#contents) Detect bound checks with [pat/boundcheck](https://github.com/maruel/pat) ⭐ 12 | 🐛 0 | 🌐 Go | 📅 2023-08-29
...
### [⏫](#contents) Detect sub-optimal struct layout with [structlayout-optimize](https://github.com/dominikh/go-tools/blob/master/cmd/structlayout-optimize) ⭐ 6,902 | 🐛 578 | 🌐 Go | 📅 2026-08-24
...
### [⏫](#contents) Visualize struct layout with [structlayout](https://github.com/dominikh/go-tools/tree/master/cmd/structlayout) ⭐ 6,902 | 🐛 578 | 🌐 Go | 📅 2026-08-24
