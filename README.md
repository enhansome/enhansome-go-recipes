...
### [⏫](#contents) Make treemap of coverage with [go-cover-treemap](https://github.com/nikolaydubina/go-cover-treemap) ⭐ 596 | 🐛 8 | 🌐 Go | 📅 2026-08-15
...
### [⏫](#contents) Run coverage collector server with [goc](https://github.com/qiniu/goc) ⭐ 875 | 🐛 101 | 🌐 Go | 📅 2026-05-03
...
### [⏫](#contents) Visualize live coverage in VSCode with [goc](https://github.com/qiniu/goc) ⭐ 875 | 🐛 101 | 🌐 Go | 📅 2026-05-03
...
### [⏫](#contents) Detect drops in coverage with [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 241 | 🐛 7 | 🌐 Go | 📅 2026-09-07
...
### [⏫](#contents) :gift: Comment code coverage reports in pull request with [go-coverage-report](https://github.com/fgrosse/go-coverage-report) ⭐ 126 | 🐛 7 | 🌐 Go | 📅 2026-09-13
...
### [⏫](#contents) :gift: Manipulate coverage profiles with [gopherage](https://github.com/kubernetes/test-infra/blob/master/gopherage) ⭐ 4,021 | 🐛 130 | 🌐 Go | 📅 2026-09-13
...
### [⏫](#contents) Detect goroutine leaks with [goleak](https://github.com/uber-go/goleak) ⭐ 5,277 | 🐛 24 | 🌐 Go | 📅 2026-08-31
...
### [⏫](#contents) Detect goroutine leaks with [leaktest](https://github.com/fortytw2/leaktest) ⭐ 1,043 | 🐛 5 | 🌐 Go | 📅 2020-10-15
...
### [⏫](#contents) Visualize test runs with [vgt](https://github.com/roblaszczak/vgt) ⭐ 363 | 🐛 2 | 🌐 Go | 📅 2025-12-15
...
### [⏫](#contents) Decorate `go test` with [richgo](https://github.com/kyoh86/richgo) ⭐ 858 | 🐛 6 | 🌐 Go | 📅 2026-07-18
...
### [⏫](#contents) Decorate `go test` with [gotest](https://github.com/rakyll/gotest) ⭐ 1,393 | 🐛 17 | 🌐 Go | 📅 2026-01-10
...
### [⏫](#contents) Decorate `go test` with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,718 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Get slowest tests with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,718 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Auto-Instrument skipping slowest tests with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,718 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Automatically re-run failed tests with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,718 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Make `JUnit` test report with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,718 | 🐛 118 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Make `JUnit` test report with [go-junit-report](https://github.com/jstemmer/go-junit-report) ⭐ 824 | 🐛 31 | 🌐 Go | 📅 2026-08-19
...
### [⏫](#contents) Report each subtest as its own case with [qualflare-go](https://github.com/Qualflare/qualflare-go) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-09-09
...
### [⏫](#contents) Perform Mutation Testing with [ooze](https://github.com/gtramontina/ooze) ⭐ 287 | 🐛 13 | 🌐 Go | 📅 2026-09-09
...
### [⏫](#contents) Perform Mutation Testing with [avito-tech/go-mutesting](https://github.com/avito-tech/go-mutesting) ⭐ 267 | 🐛 25 | 🌐 Go | 📅 2026-01-12

This is fork of [zimmski/go-mutesting](https://github.com/zimmski/go-mutesting) ⭐ 672 | 🐛 43 | 🌐 Go | 📅 2024-07-04. It has more mutators and latest updates. — [@vasiliyyudin](https://github.com/vasiliyyudin)
...
### [⏫](#contents) :gift: Perform Mutation Testing with [jonbaldie/go-mutesting](https://github.com/jonbaldie/go-mutesting) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2026-09-13
...
### [⏫](#contents) Perform Mutation Testing with [go-mutesting](https://github.com/zimmski/go-mutesting) ⭐ 672 | 🐛 43 | 🌐 Go | 📅 2024-07-04
...
### [⏫](#contents) Get go module libyear, number of releases, version delta with [go-libyear](https://github.com/nieomylnieja/go-libyear) ⭐ 42 | 🐛 6 | 🌐 Go | 📅 2026-09-08
...
### [⏫](#contents) Scrape licenses of upstream dependencies with [go-licenses](https://github.com/google/go-licenses) ⭐ 1,016 | 🐛 58 | 🌐 Go | 📅 2026-07-09
...
### [⏫](#contents) Explore dependencies with [goda](https://github.com/loov/goda) ⭐ 1,725 | 🐛 20 | 🌐 Go | 📅 2026-08-25
...
### [⏫](#contents) Enforce Go code architecture with [go-arch-lint](https://github.com/fe3dback/go-arch-lint) ⭐ 553 | 🐛 18 | 🌐 Go | 📅 2026-09-07
...
### [⏫](#contents) Make PlantUML diagram with [goplantuml](https://github.com/jfeliu007/goplantuml) ⭐ 2,083 | 🐛 39 | 🌐 Go | 📅 2025-10-16
...
### [⏫](#contents) Visualize the entropy of a code base with a 3D force-directed graph with [dep-tree](https://github.com/gabotechs/dep-tree) ⭐ 1,724 | 🐛 9 | 🌐 Go | 📅 2025-03-22
...
### [⏫](#contents) Make D2 graph of architecture and dependencies with [go-arch-lint graph](https://github.com/fe3dback/go-arch-lint) ⭐ 553 | 🐛 18 | 🌐 Go | 📅 2026-09-07
...
Official Go team [encourages](https://github.com/golang/go/issues/20520) ⭐ 138,799 | 🐛 10,136 | 🌐 Go | 📅 2026-09-13 to run sequentially. However, in certain situations, such as lots of mocks, parallelization helps a lot, albeit, you should consider including your generated files in git. The solution below spawns multiple processes, each per pkg.
...
### [⏫](#contents) Generate data types from JSON Schema with [go-jsonschema](https://github.com/omissis/go-jsonschema) ⭐ 805 | 🐛 86 | 🌐 Go | 📅 2026-09-06
...
### [⏫](#contents) Generate constructor for a struct with [gonstructor](https://github.com/moznion/gonstructor) ⭐ 94 | 🐛 10 | 🌐 Go | 📅 2026-09-08
...
### [⏫](#contents) Generate mocks with [mockgen](https://github.com/uber-go/mock) ⭐ 3,405 | 🐛 112 | 🌐 Go | 📅 2026-08-25
...
### [⏫](#contents) Generate interface for a struct with [ifacemaker](https://github.com/vburenin/ifacemaker) ⭐ 355 | 🐛 0 | 🌐 Go | 📅 2026-09-06
...
### [⏫](#contents) Generate decorator for interface with [gowrap](https://github.com/hexdigest/gowrap) ⭐ 1,338 | 🐛 21 | 🌐 Go | 📅 2026-09-02
...
### [⏫](#contents) Modify struct field tags with [gomodifytags](https://github.com/fatih/gomodifytags) ⭐ 2,395 | 🐛 13 | 🌐 Go | 📅 2025-04-23
...
### [⏫](#contents) Generate code from OpenAPI 3 specification with [oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) ⭐ 8,571 | 🐛 322 | 🌐 Go | 📅 2026-09-09
...
### [⏫](#contents) Enum via generics with [enum](https://github.com/orsinium-labs/enum) ⭐ 463 | 🐛 0 | 🌐 Go | 📅 2025-08-17
...
I found this in announcement [notice](https://github.com/golang/go/commit/2580d0e08d5e9f979b943758d3c49877fb2324cb) ⭐ 138,799 | 🐛 10,136 | 🌐 Go | 📅 2026-09-13 of Go 1.18 for changes to `interface{}` to `any`. This can be useful for other refactorings too.
...
### [⏫](#contents) Keep consistent ordering of imports with [gci](https://github.com/daixiang0/gci) ⭐ 576 | 🐛 29 | 🌐 Go | 📅 2026-03-16
...
### [⏫](#contents) Pretty print `panic` messages with [panicparse](https://github.com/maruel/panicparse) ⭐ 3,706 | 🐛 3 | 🌐 Go | 📅 2026-07-13
...
### [⏫](#contents) Build for Raspberry Pi, Virtual Machine, embedded or normal PC with [gokrazy](https://github.com/gokrazy/gokrazy) ⭐ 3,490 | 🐛 51 | 🌐 JavaScript | 📅 2026-09-05
...
### [⏫](#contents) Visualise dependencies size in compiled binaries with [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 2,177 | 🐛 8 | 🌐 Go | 📅 2026-09-07
...
### [⏫](#contents) Manage multiple Go versions with [Goenv](https://github.com/Norwik/Goenv) ⭐ 36 | 🐛 14 | 🌐 Go | 📅 2026-09-03
...
### [⏫](#contents) Transpile Go to Javascript with [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 13,183 | 🐛 189 | 🌐 Go | 📅 2026-08-20
...
### [⏫](#contents) Run compile-time function evaluation with [prep](https://github.com/pijng/prep) ⭐ 500 | 🐛 0 | 🌐 Go | 📅 2025-07-22
...
### [⏫](#contents) Generate Go assembly in Go with [avo](https://github.com/mmcloughlin/avo) ⭐ 2,990 | 🐛 97 | 🌐 Go | 📅 2026-09-01
...
### [⏫](#contents) Make graph of AST with [astgraph](https://github.com/xiazemin/ast_graph) ⭐ 20 | 🐛 0 | 🌐 Go | 📅 2026-09-07
...
### [⏫](#contents) Run alternative Go Playground with [goplay.tools](https://github.com/x1unix/go-playground) ⭐ 1,487 | 🐛 7 | 🌐 Go | 📅 2026-09-13
...
### [⏫](#contents) Run interactive Go kernels in Jupyter Notebook with [gophernotes](https://github.com/gopherdata/gophernotes) ⭐ 3,966 | 🐛 54 | 🌐 Go | 📅 2026-09-09
...
### [⏫](#contents) Run interactive Go interpreter with [yaegi](https://github.com/traefik/yaegi) ⭐ 8,392 | 🐛 186 | 🌐 Go | 📅 2026-02-09
...
### [⏫](#contents) Run interactive Go interpreter with [gomacro](https://github.com/cosmos72/gomacro) ⭐ 2,300 | 🐛 49 | 🌐 Go | 📅 2026-09-01
...
### [⏫](#contents) Run Go function in shell with [gosh](https://github.com/nickwells/utilities/blob/master/gosh/_gosh.DOC.md) ⭐ 41 | 🐛 2 | 🌐 Go | 📅 2026-09-07
...
### [⏫](#contents) Monitor Go processes with [gops](https://github.com/google/gops) ⭐ 7,013 | 🐛 34 | 🌐 Go | 📅 2026-07-16
...
### [⏫](#contents) Monitor Go runtime metrics in browser with [live-pprof](https://github.com/moderato-app/live-pprof) ⭐ 317 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-01
...
### [⏫](#contents) Monitor Go runtime metrics in browser with [statsviz](https://github.com/arl/statsviz) ⭐ 3,645 | 🐛 9 | 🌐 Go | 📅 2026-09-11
...
### [⏫](#contents) Auto-Instrument all functions with [otelinji](https://github.com/hedhyw/otelinji) ⭐ 29 | 🐛 7 | 🌐 Go | 📅 2026-09-01
...
### [⏫](#contents) Auto-Instrument functions for DataDog with [orchestrion](https://github.com/DataDog/orchestrion) ⭐ 622 | 🐛 19 | 🌐 Go | 📅 2026-09-11
...
### [⏫](#contents) Continuous Profiling with [Pyroscope](https://github.com/grafana/pyroscope) ⭐ 11,657 | 🐛 396 | 🌐 Go | 📅 2026-09-11
...
Track how benchmarks change in codebase over time. This is accomplished by running benchmarks for git commits, storing results, and visualizing difference. Running benchmarks can be in GitHub Actions or locally, storage can be in same repository `master` or dedicated branch, or standalone servers. It should be straightforward to setup this manually. Example of GitHub Action [spec](https://github.com/swaggest/rest/blob/master/.github/workflows/bench.yml) ⭐ 486 | 🐛 19 | 🌐 Go | 📅 2026-04-07 and [blog](https://dev.to/vearutop/continuous-benchmarking-with-go-and-github-actions-41ok) from [@vearutop](https://github.com/vearutop), and an example on how it produces a PR [comment](https://github.com/swaggest/rest/pull/88#issuecomment-1271540878) ⭐ 486 | 🐛 19 | 🌐 Go | 📅 2026-04-07.
...
* [Uber](https://github.com/uber-go/guide) ⭐ 17,702 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15
...
### [⏫](#contents) Detect escalated privileges in dependencies with [capslock](https://github.com/google/capslock) ⭐ 1,179 | 🐛 12 | 🌐 Go | 📅 2026-09-04
...
### [⏫](#contents) Run static analysis with [gosec](https://github.com/securego/gosec) ⭐ 8,945 | 🐛 7 | 🌐 Go | 📅 2026-09-07
...
### [⏫](#contents) Use Microsoft Go compiler with [microsoft/go](https://github.com/microsoft/go) ⭐ 431 | 🐛 127 | 🌐 Go | 📅 2026-09-13
...
### [⏫](#contents) Detect most common issues with [staticcheck](https://github.com/dominikh/go-tools) ⭐ 6,892 | 🐛 575 | 🌐 Go | 📅 2026-08-24
...
### [⏫](#contents) Detect common style, performance, and naming issues with [revive](https://github.com/mgechev/revive) ⭐ 5,551 | 🐛 74 | 🌐 Go | 📅 2026-09-10
...
### [⏫](#contents) Detect potential Nil panics with [nilaway](https://github.com/uber-go/nilaway) ⭐ 3,905 | 🐛 77 | 🌐 Go | 📅 2026-09-11
...
### [⏫](#contents) Detect most common issues with [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,068 | 🐛 152 | 🌐 Go | 📅 2026-09-07
...
### [⏫](#contents) Detect non-exhaustive switch and map with [exhaustive](https://github.com/nishanths/exhaustive) ⭐ 347 | 🐛 12 | 🌐 Go | 📅 2026-09-13
...
### [⏫](#contents) Detect structs with uninitialized fields with [go-exhaustruct](https://github.com/GaijinEntertainment/go-exhaustruct) ⭐ 205 | 🐛 6 | 🌐 Go | 📅 2026-09-04
...
### [⏫](#contents) Detect `panic` without explaining comment with [panic-linter](https://github.com/ldemailly/panic-linter) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-08-29
...
### [⏫](#contents) Detect global variables with [gochecknoglobals](https://github.com/leighmcculloch/gochecknoglobals) ⭐ 136 | 🐛 7 | 🌐 Go | 📅 2026-02-15
...
### [⏫](#contents) Calculate Cognitive Complexity with [gocognit](https://github.com/uudashr/gocognit) ⭐ 491 | 🐛 2 | 🌐 Go | 📅 2026-02-24
...
### [⏫](#contents) Calculate Cyclomatic Complexity with [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,608 | 🐛 11 | 🌐 Go | 📅 2025-12-27
...
### [⏫](#contents) Detect sub-optimal struct layout with [betteralign](https://github.com/dkorunic/betteralign) ⭐ 1,083 | 🐛 0 | 🌐 Go | 📅 2026-09-08
...
### [⏫](#contents) Detect sub-optimal struct layout with [structlayout-optimize](https://github.com/dominikh/go-tools/blob/master/cmd/structlayout-optimize) ⭐ 6,892 | 🐛 575 | 🌐 Go | 📅 2026-08-24
...
### [⏫](#contents) Visualize struct layout with [structlayout](https://github.com/dominikh/go-tools/tree/master/cmd/structlayout) ⭐ 6,892 | 🐛 575 | 🌐 Go | 📅 2026-08-24
