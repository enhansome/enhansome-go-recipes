...
### [⏫](#contents) Make treemap of coverage with [go-cover-treemap](https://github.com/nikolaydubina/go-cover-treemap) ⭐ 597 | 🐛 8 | 🌐 Go | 📅 2026-08-02
...
### [⏫](#contents) Browse coverage with [gocov-html](https://github.com/matm/gocov-html) ⭐ 229 | 🐛 2 | 🌐 Go | 📅 2024-12-19
...
### [⏫](#contents) Browse coverage with [xgo](https://github.com/xhd2015/xgo) ⭐ 431 | 🐛 65 | 🌐 Go | 📅 2026-08-12
...
### [⏫](#contents) Browse coverage in terminal with [gocovsh](https://github.com/orlangure/gocovsh) ⭐ 387 | 🐛 13 | 🌐 Go | 📅 2025-12-05
...
### [⏫](#contents) Pretty print coverage in terminal with [nikandfor/cover](https://github.com/nikandfor/cover) ⭐ 8 | 🐛 0 | 🌐 Go | 📅 2025-02-13
...
### [⏫](#contents) Run coverage collector server with [goc](https://github.com/qiniu/goc) ⭐ 873 | 🐛 101 | 🌐 Go | 📅 2026-05-03
...
### [⏫](#contents) Visualize live coverage in VSCode with [goc](https://github.com/qiniu/goc) ⭐ 873 | 🐛 101 | 🌐 Go | 📅 2026-05-03
...
### [⏫](#contents) Detect drops in coverage with [go-test-coverage](https://github.com/vladopajic/go-test-coverage) ⭐ 236 | 🐛 7 | 🌐 Go | 📅 2026-08-10
...
### [⏫](#contents) :gift: Comment code coverage reports in pull request with [go-coverage-report](https://github.com/fgrosse/go-coverage-report) ⭐ 124 | 🐛 5 | 🌐 Go | 📅 2026-08-08
...
### [⏫](#contents) :gift: Manipulate coverage profiles with [gopherage](https://github.com/kubernetes/test-infra/blob/master/gopherage) ⭐ 4,013 | 🐛 121 | 🌐 Go | 📅 2026-08-14
...
### [⏫](#contents) :gift: Fuzz Go binaries using LibAFL with [GoLibAFL](https://github.com/srlabs/golibafl) ⭐ 72 | 🐛 1 | 🌐 Go | 📅 2026-02-19
...
### [⏫](#contents) Detect goroutine leaks with [goleak](https://github.com/uber-go/goleak) ⭐ 5,254 | 🐛 23 | 🌐 Go | 📅 2026-06-02
...
### [⏫](#contents) Detect goroutine leaks with [leaktest](https://github.com/fortytw2/leaktest) ⭐ 1,044 | 🐛 5 | 🌐 Go | 📅 2020-10-15
...
### [⏫](#contents) Visualize test runs with [vgt](https://github.com/roblaszczak/vgt) ⭐ 362 | 🐛 2 | 🌐 Go | 📅 2025-12-15
...
### [⏫](#contents) Decorate `go test` with [richgo](https://github.com/kyoh86/richgo) ⭐ 860 | 🐛 6 | 🌐 Go | 📅 2026-07-18
...
### [⏫](#contents) Decorate `go test` with [gotest](https://github.com/rakyll/gotest) ⭐ 1,398 | 🐛 17 | 🌐 Go | 📅 2026-01-10
...
### [⏫](#contents) Decorate `go test` with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,703 | 🐛 116 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Format `go test` results as documentation with [gotestdox](https://github.com/bitfield/gotestdox) ⭐ 201 | 🐛 3 | 🌐 Go | 📅 2026-07-22
...
### [⏫](#contents) Get slowest tests with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,703 | 🐛 116 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Auto-Instrument skipping slowest tests with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,703 | 🐛 116 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Automatically re-run failed tests with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,703 | 🐛 116 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Make `JUnit` test report with [gotestsum](https://github.com/gotestyourself/gotestsum) ⭐ 2,703 | 🐛 116 | 🌐 Go | 📅 2026-04-15
...
### [⏫](#contents) Make `JUnit` test report with [go-junit-report](https://github.com/jstemmer/go-junit-report) ⭐ 823 | 🐛 32 | 🌐 Go | 📅 2024-08-20
...
### [⏫](#contents) Perform Mutation Testing with [ooze](https://github.com/gtramontina/ooze) ⭐ 284 | 🐛 14 | 🌐 Go | 📅 2026-08-04
...
### [⏫](#contents) Perform Mutation Testing with [avito-tech/go-mutesting](https://github.com/avito-tech/go-mutesting) ⭐ 257 | 🐛 25 | 🌐 Go | 📅 2026-01-12
...
### [⏫](#contents) :gift: Perform Mutation Testing with [jonbaldie/go-mutesting](https://github.com/jonbaldie/go-mutesting) ⭐ 4 | 🐛 0 | 🌐 Go | 📅 2026-08-06
...
### [⏫](#contents) Perform Mutation Testing with [go-mutesting](https://github.com/zimmski/go-mutesting) ⭐ 673 | 🐛 43 | 🌐 Go | 📅 2024-07-04
...
### [⏫](#contents) Get go module libyear, number of releases, version delta with [go-libyear](https://github.com/nieomylnieja/go-libyear) ⭐ 42 | 🐛 4 | 🌐 Go | 📅 2026-08-14
...
### [⏫](#contents) Make graph of upstream packages with [import-graph](https://github.com/nikolaydubina/import-graph) ⚠️ Archived
...
### [⏫](#contents) Scrape details about upstream modules and make graph with [import-graph](https://github.com/nikolaydubina/import-graph) ⚠️ Archived
...
### [⏫](#contents) Scrape licenses of upstream dependencies with [go-licenses](https://github.com/google/go-licenses) ⭐ 1,009 | 🐛 56 | 🌐 Go | 📅 2026-07-09
...
### [⏫](#contents) Explore dependencies with [goda](https://github.com/loov/goda) ⭐ 1,720 | 🐛 20 | 🌐 Go | 📅 2026-07-02
...
### [⏫](#contents) Explore dependencies interactively with [spaghetti](https://github.com/adonovan/spaghetti) ⭐ 765 | 🐛 3 | 🌐 Go | 📅 2023-05-19
...
### [⏫](#contents) Explore dependencies graph interactively with [modview](https://github.com/bayraktugrul/modview) ⭐ 226 | 🐛 2 | 🌐 Go | 📅 2024-12-19
...
### [⏫](#contents) Explore dependencies graph in CLI with [depth](https://github.com/KyleBanks/depth) ⭐ 1,083 | 🐛 10 | 🌐 Go | 📅 2022-02-08
...
### [⏫](#contents) Explore your `GOPATH` with GUI with [goggles](https://github.com/KyleBanks/goggles) ⭐ 662 | 🐛 7 | 🌐 Go | 📅 2017-10-29
...
### [⏫](#contents) Enforce Go code architecture with [go-arch-lint](https://github.com/fe3dback/go-arch-lint) ⭐ 528 | 🐛 17 | 🌐 Go | 📅 2026-08-05
...
### [⏫](#contents) Check Clean Architecture with [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) ⭐ 984 | 🐛 5 | 🌐 Go | 📅 2021-11-08
...
### [⏫](#contents) Make C4 diagram with [go-structurizr](https://github.com/krzysztofreczek/go-structurizr) ⭐ 366 | 🐛 0 | 🌐 Go | 📅 2026-07-15
...
### [⏫](#contents) Make graph of function calls in package with [go-callvis](https://github.com/ofabry/go-callvis) ⭐ 6,504 | 🐛 73 | 🌐 Go | 📅 2026-03-30
...
### [⏫](#contents) Make PlantUML diagram with [goplantuml](https://github.com/jfeliu007/goplantuml) ⭐ 2,089 | 🐛 39 | 🌐 Go | 📅 2025-10-16
...
### [⏫](#contents) Make PlantUML diagram with [go-plantuml](https://github.com/bykof/go-plantuml) ⭐ 411 | 🐛 3 | 🌐 Go | 📅 2024-12-20
...
### [⏫](#contents) Visualize the entropy of a code base with a 3D force-directed graph with [dep-tree](https://github.com/gabotechs/dep-tree) ⭐ 1,723 | 🐛 9 | 🌐 Go | 📅 2025-03-22
...
### [⏫](#contents) Explore Go code in browser powered by `go-guru` with [pythia](https://github.com/fzipp/pythia) ⭐ 336 | 🐛 6 | 🌐 Go | 📅 2025-03-06
...
### [⏫](#contents) Interactively visualize packages with [goexplorer](https://github.com/ofabry/goexplorer) ⭐ 178 | 🐛 1 | 🌐 JavaScript | 📅 2017-10-31
...
### [⏫](#contents) Make D2 graph of architecture and dependencies with [go-arch-lint graph](https://github.com/fe3dback/go-arch-lint) ⭐ 528 | 🐛 17 | 🌐 Go | 📅 2026-08-05
...
Official Go team [encourages](https://github.com/golang/go/issues/20520) ⭐ 135,769 | 🐛 10,222 | 🌐 Go | 📅 2026-08-14 to run sequentially. However, in certain situations, such as lots of mocks, parallelization helps a lot, albeit, you should consider including your generated files in git. The solution below spawns multiple processes, each per pkg.
...
### [⏫](#contents) Generate enums encoding with [go-enum-encoding](https://github.com/nikolaydubina/go-enum-encoding) ⭐ 16 | 🐛 1 | 🌐 Go | 📅 2026-08-02
...
### [⏫](#contents) Generate enums with [goenums](https://github.com/zarldev/goenums) ⭐ 374 | 🐛 0 | 🌐 Go | 📅 2026-07-24
...
### [⏫](#contents) Generate data types from JSON Schema with [go-jsonschema](https://github.com/omissis/go-jsonschema) ⭐ 804 | 🐛 76 | 🌐 Go | 📅 2026-08-14
...
### [⏫](#contents) Generate constructor for a struct with [gonstructor](https://github.com/moznion/gonstructor) ⭐ 94 | 🐛 9 | 🌐 Go | 📅 2026-08-13
...
### [⏫](#contents) Generate Table Driven Tests with [gotests](https://github.com/cweill/gotests) ⭐ 5,326 | 🐛 39 | 🌐 Go | 📅 2025-10-30
...
### [⏫](#contents) Generate mocks with [mockgen](https://github.com/uber-go/mock) ⭐ 3,396 | 🐛 111 | 🌐 Go | 📅 2026-08-09
...
### [⏫](#contents) Generate interface for a struct with [ifacemaker](https://github.com/vburenin/ifacemaker) ⭐ 354 | 🐛 2 | 🌐 Go | 📅 2026-07-16
...
### [⏫](#contents) Generate interface for a struct with [interfacer](https://github.com/rjeczalik/interfaces) ⭐ 431 | 🐛 15 | 🌐 Go | 📅 2025-06-03
...
### [⏫](#contents) Generate interface for a struct with [struct2interface](https://github.com/reflog/struct2interface) ⭐ 20 | 🐛 0 | 🌐 Go | 📅 2020-04-08
...
### [⏫](#contents) Generate interface for `CSV` file with [structer](https://github.com/rjeczalik/interfaces) ⭐ 431 | 🐛 15 | 🌐 Go | 📅 2025-06-03
...
### [⏫](#contents) Modify struct field tags with [gomodifytags](https://github.com/fatih/gomodifytags) ⭐ 2,389 | 🐛 13 | 🌐 Go | 📅 2025-04-23
...
### [⏫](#contents) Generate code from OpenAPI 3 specification with [oapi-codegen](https://github.com/oapi-codegen/oapi-codegen) ⭐ 8,513 | 🐛 314 | 🌐 Go | 📅 2026-08-13
...
### [⏫](#contents) Generate C-Go Bindings with [c-for-go](https://github.com/xlab/c-for-go?tab=readme-ov-file) ⭐ 1,681 | 🐛 78 | 🌐 Go | 📅 2026-03-05
...
### [⏫](#contents) Enum via generics with [enum](https://github.com/orsinium-labs/enum) ⭐ 462 | 🐛 0 | 🌐 Go | 📅 2025-08-17
...
I found this in announcement [notice](https://github.com/golang/go/commit/2580d0e08d5e9f979b943758d3c49877fb2324cb) ⭐ 135,769 | 🐛 10,222 | 🌐 Go | 📅 2026-08-14 of Go 1.18 for changes to `interface{}` to `any`. This can be useful for other refactorings too.

```
gofmt -w -r 'interface{} -> any' .
```

### [⏫](#contents) Apply refactoring patches with [gopatch](https://github.com/uber-go/gopatch) ⭐ 1,039 | 🐛 33 | 🌐 Go | 📅 2025-02-11
...
### [⏫](#contents) Keep consistent ordering of imports with [gci](https://github.com/daixiang0/gci) ⭐ 569 | 🐛 28 | 🌐 Go | 📅 2026-03-16
...
### [⏫](#contents) Keep consistent ordering of imports with [goimportx](https://github.com/anqiansong/goimportx/tree/main) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2024-06-03
...
### [⏫](#contents) Errors with return traces with [errtrace](https://github.com/bracesdev/errtrace) ⭐ 824 | 🐛 14 | 🌐 Go | 📅 2026-03-30
...
### [⏫](#contents) Errors with stack traces and source fragments with [tracerr](https://github.com/ztrue/tracerr) ⭐ 1,119 | 🐛 4 | 🌐 Go | 📅 2026-04-02
...
### [⏫](#contents) Pretty print `panic` messages with [panicparse](https://github.com/maruel/panicparse) ⭐ 3,709 | 🐛 3 | 🌐 Go | 📅 2026-07-13
...
### [⏫](#contents) :gift: Generate errors from a spec with [zederr](https://github.com/amanbolat/zederr) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2024-07-01
...
### [⏫](#contents) Build for Raspberry Pi, Virtual Machine, embedded or normal PC with [gokrazy](https://github.com/gokrazy/gokrazy) ⭐ 3,474 | 🐛 48 | 🌐 JavaScript | 📅 2026-08-04
...
### [⏫](#contents) Visualise dependencies size in compiled binaries with [go-size-analyzer](https://github.com/Zxilly/go-size-analyzer) ⭐ 2,162 | 🐛 8 | 🌐 Go | 📅 2026-08-10
...
### [⏫](#contents) Make treemap breakdown of Go executable binary with [go-binsize-treemap](https://github.com/nikolaydubina/go-binsize-treemap) ⭐ 588 | 🐛 4 | 🌐 Go | 📅 2026-08-02
...
### [⏫](#contents) Custom import path with [govanityurls](https://github.com/GoogleCloudPlatform/govanityurls) ⚠️ Archived
...
### [⏫](#contents) Custom import path with [sally](https://github.com/uber-go/sally) ⭐ 347 | 🐛 6 | 🌐 Go | 📅 2025-05-06
...
### [⏫](#contents) Manage multiple Go versions with [Goenv](https://github.com/Norwik/Goenv) ⭐ 36 | 🐛 14 | 🌐 Go | 📅 2026-08-14
...
### [⏫](#contents) Transpile C to Go with [cxgo](https://github.com/gotranspile/cxgo) ⭐ 395 | 🐛 36 | 🌐 Go | 📅 2025-03-18
...
### [⏫](#contents) Transpile Go to Javascript with [gopherjs](https://github.com/gopherjs/gopherjs) ⭐ 13,172 | 🐛 191 | 🌐 Go | 📅 2026-07-27
...
### [⏫](#contents) :gift: Containerize your builds with [brewkit](https://github.com/ispringtech/brewkit) ⭐ 28 | 🐛 3 | 🌐 Go | 📅 2025-05-14
...
### [⏫](#contents) Get Go SSA intermediary representation with [ssaplayground](https://github.com/golang-design/ssaplayground) ⭐ 81 | 🐛 0 | 🌐 Go | 📅 2026-06-06
...
### [⏫](#contents) View Go assembly with color annotation with [pat/disfunc](https://github.com/maruel/pat) ⭐ 11 | 🐛 0 | 🌐 Go | 📅 2023-08-29
...
### [⏫](#contents) Generate Go assembly in Go with [avo](https://github.com/mmcloughlin/avo) ⭐ 2,987 | 🐛 96 | 🌐 Go | 📅 2026-08-01
...
### [⏫](#contents) Generate AST for code snippets with [go2ast](https://github.com/reflog/go2ast) ⭐ 124 | 🐛 1 | 🌐 Go | 📅 2019-11-07
...
### [⏫](#contents) Visualize Go SSA function using Graphviz with [go-ssaviz](https://github.com/SilverRainZ/go-ssaviz) ⭐ 50 | 🐛 1 | 🌐 Go | 📅 2025-05-30
...
### [⏫](#contents) Make graph of AST with [astgraph](https://github.com/xiazemin/ast_graph) ⭐ 20 | 🐛 3 | 🌐 Go | 📅 2023-04-28
...
### [⏫](#contents) Convert C assembly to Go assembly with [c2goasm](https://github.com/minio/c2goasm) ⚠️ Archived
...
### [⏫](#contents) Run alternative Go Playground with [goplay.tools](https://github.com/x1unix/go-playground) ⭐ 1,485 | 🐛 6 | 🌐 Go | 📅 2026-08-11
...
### [⏫](#contents) Run interactive Go kernels in Jupyter Notebook with [gophernotes](https://github.com/gopherdata/gophernotes) ⭐ 3,966 | 🐛 55 | 🌐 Go | 📅 2023-11-03
...
### [⏫](#contents) Run interactive Go interpreter with [yaegi](https://github.com/traefik/yaegi) ⭐ 8,363 | 🐛 184 | 🌐 Go | 📅 2026-02-09
...
### [⏫](#contents) Run interactive Go interpreter with [gomacro](https://github.com/cosmos72/gomacro) ⭐ 2,287 | 🐛 49 | 🌐 Go | 📅 2026-08-02
...
### [⏫](#contents) Run Go function in shell with [gosh](https://github.com/nickwells/utilities/blob/master/gosh/_gosh.DOC.md) ⭐ 41 | 🐛 2 | 🌐 Go | 📅 2026-06-23
...
### [⏫](#contents) Create 3D visualization of concurrency traces with [gotrace](https://github.com/divan/gotrace) ⭐ 1,980 | 🐛 18 | 🌐 JavaScript | 📅 2022-11-12
...
These are standard metrics for Go runtime exposed in OpenTelemetry format. Grafana [dashboard](https://github.com/nikolaydubina/grafana-otel-go-runtime) ⭐ 6 | 🐛 0 | 📅 2026-08-02. — Google, (dashboard by @nikolaydubina)
...
### [⏫](#contents) Monitor goroutines with [grmon](https://github.com/bcicen/grmon) ⭐ 1,892 | 🐛 4 | 🌐 Go | 📅 2023-07-18
...
### [⏫](#contents) Monitor Go runtime metrics in browser with [live-pprof](https://github.com/moderato-app/live-pprof) ⭐ 318 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-01
...
### [⏫](#contents) Monitor Go runtime metrics in browser with [statsviz](https://github.com/arl/statsviz) ⭐ 3,647 | 🐛 15 | 🌐 Go | 📅 2026-08-10
...
### [⏫](#contents) Auto-Instrument all functions with [go-instrument](https://github.com/nikolaydubina/go-instrument) ⭐ 299 | 🐛 3 | 🌐 Go | 📅 2026-08-09
...
### [⏫](#contents) Auto-Instrument all functions with [otelinji](https://github.com/hedhyw/otelinji) ⭐ 29 | 🐛 2 | 🌐 Go | 📅 2026-07-31
...
### [⏫](#contents) Auto-Instrument functions for DataDog with [orchestrion](https://github.com/DataDog/orchestrion) ⭐ 620 | 🐛 21 | 🌐 Go | 📅 2026-08-14
...
### [⏫](#contents) Continuous Profiling with [Pyroscope](https://github.com/grafana/pyroscope) ⭐ 11,625 | 🐛 402 | 🌐 Go | 📅 2026-08-14
...
### [⏫](#contents) :gift: Profile and visualize (with video) Go profiles through eBPF with [go-profile](https://github.com/benbaker76/go-profile) ⭐ 29 | 🐛 0 | 🌐 C | 📅 2025-03-25
...
### [⏫](#contents) Benchmark against git commit with [pat/ba](https://github.com/maruel/pat) ⭐ 11 | 🐛 0 | 🌐 Go | 📅 2023-08-29
...
Track how benchmarks change in codebase over time. This is accomplished by running benchmarks for git commits, storing results, and visualizing difference. Running benchmarks can be in GitHub Actions or locally, storage can be in same repository `master` or dedicated branch, or standalone servers. It should be straightforward to setup this manually. Example of GitHub Action [spec](https://github.com/swaggest/rest/blob/master/.github/workflows/bench.yml) ⭐ 487 | 🐛 19 | 🌐 Go | 📅 2026-04-07 and [blog](https://dev.to/vearutop/continuous-benchmarking-with-go-and-github-actions-41ok) from [@vearutop](https://github.com/vearutop), and an example on how it produces a PR [comment](https://github.com/swaggest/rest/pull/88#issuecomment-1271540878) ⭐ 487 | 🐛 19 | 🌐 Go | 📅 2026-04-07.

<div align="center"><img src="img/cont-bench-vearutop.png" style="margin: 8px; max-height: 640px;"></div>

### [⏫](#contents) Continuous benchmarking with [gobenchdata](https://github.com/bobheadxi/gobenchdata) ⭐ 157 | 🐛 12 | 🌐 Go | 📅 2024-10-28
...
### [⏫](#contents) Continuous benchmarking with [benchdiff](https://github.com/willabides/benchdiff) ⭐ 68 | 🐛 4 | 🌐 Go | 📅 2023-05-16
...
### [⏫](#contents) Continuous benchmarking with [cob](https://github.com/knqyf263/cob) ⭐ 390 | 🐛 12 | 🌐 Go | 📅 2026-08-03
...
### [⏫](#contents) View traces with [gotraceui](https://github.com/dominikh/gotraceui) ⭐ 1,406 | 🐛 96 | 🌐 Go | 📅 2025-12-15
...
### [⏫](#contents) View in-process traces with [trc](https://github.com/peterbourgon/trc) ⭐ 103 | 🐛 0 | 🌐 Go | 📅 2026-01-27
...
### [⏫](#contents) Get on/off CPU profiles with [fgprof](https://github.com/felixge/fgprof) ⭐ 3,110 | 🐛 7 | 🌐 Go | 📅 2025-05-02
...
### [⏫](#contents) Read Go binary documentation in `man` format with [goman](https://github.com/appliedgocode/goman) ⭐ 128 | 🐛 0 | 🌐 Go | 📅 2026-07-09
...
### [⏫](#contents) Generate badge with [gobadge](https://github.com/AlexBeauchemin/gobadge) ⭐ 24 | 🐛 2 | 🌐 Go | 📅 2025-01-01

This tool will generate instructions for [shields.io](https://shields.io) to generate badge. It can read `coverprofile`. There is also GitHub Action that utilizes it and stores badge in the same repo, [coverage-badge-go](https://github.com/tj-actions/coverage-badge-go) ⭐ 82 | 🐛 2 | 🌐 Go | 📅 2025-09-12. — [@AlexBeauchemin](https://github.com/AlexBeauchemin)
...
* [Uber](https://github.com/uber-go/guide) ⭐ 17,659 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15
...
### [⏫](#contents) Detect escalated privileges in dependencies with [capslock](https://github.com/google/capslock) ⭐ 1,171 | 🐛 16 | 🌐 Go | 📅 2026-07-28
...
### [⏫](#contents) Run static analysis with [gosec](https://github.com/securego/gosec) ⭐ 8,921 | 🐛 4 | 🌐 Go | 📅 2026-08-10
...
### [⏫](#contents) Use Microsoft Go compiler with [microsoft/go](https://github.com/microsoft/go) ⭐ 429 | 🐛 129 | 🌐 Go | 📅 2026-08-14
...
### [⏫](#contents) Detect most common issues with [staticcheck](https://github.com/dominikh/go-tools) ⭐ 6,849 | 🐛 575 | 🌐 Go | 📅 2026-06-30
...
### [⏫](#contents) Detect common style, performance, and naming issues with [revive](https://github.com/mgechev/revive) ⭐ 5,540 | 🐛 82 | 🌐 Go | 📅 2026-08-12
...
### [⏫](#contents) Detect potential Nil panics with [nilaway](https://github.com/uber-go/nilaway) ⭐ 3,893 | 🐛 78 | 🌐 Go | 📅 2026-08-08
...
### [⏫](#contents) Detect most common issues with [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,064 | 🐛 152 | 🌐 Go | 📅 2026-06-26
...
### [⏫](#contents) Detect non-exhaustive switch and map with [exhaustive](https://github.com/nishanths/exhaustive) ⭐ 345 | 🐛 13 | 🌐 Go | 📅 2024-12-05
...
### [⏫](#contents) Detect structs with uninitialized fields with [go-exhaustruct](https://github.com/GaijinEntertainment/go-exhaustruct) ⭐ 202 | 🐛 11 | 🌐 Go | 📅 2026-08-05
...
### [⏫](#contents) :gift: Detect missing cascade calls with [go-lint-cascade](https://github.com/nikolaydubina/go-lint-cascade) ⭐ 2 | 🐛 1 | 🌐 Go | 📅 2026-08-02
...
### [⏫](#contents) Detect unsafe code with [go-safer](https://github.com/jlauinger/go-safer) ⭐ 44 | 🐛 1 | 🌐 Go | 📅 2022-11-28
...
### [⏫](#contents) Detect `panic` without explaining comment with [panic-linter](https://github.com/ldemailly/panic-linter) ⭐ 1 | 🐛 0 | 🌐 Go | 📅 2026-07-10
...
### [⏫](#contents) Detect unnecessary type conversions with [unconvert](https://github.com/mdempsky/unconvert) ⭐ 387 | 🐛 9 | 🌐 Go | 📅 2025-02-16
...
### [⏫](#contents) Detect global variables with [gochecknoglobals](https://github.com/leighmcculloch/gochecknoglobals) ⭐ 133 | 🐛 7 | 🌐 Go | 📅 2026-02-15
...
### [⏫](#contents) Detect slices that could be preallocated with [prealloc](https://github.com/alexkohler/prealloc) ⭐ 666 | 🐛 3 | 🌐 Go | 📅 2026-02-26
...
### [⏫](#contents) Detect unnecessary import aliases with [unimport](https://github.com/alexkohler/unimport) ⭐ 71 | 🐛 1 | 🌐 Go | 📅 2017-11-06
...
### [⏫](#contents) Detect unexpected import aliases with [importas](https://github.com/julz/importas) ⭐ 18 | 🐛 8 | 🌐 Go | 📅 2024-12-26
...
### [⏫](#contents) Detect inconsistent import aliases with [consistentimports](https://github.com/nikolaydubina/consistentimports) ⭐ 2 | 🐛 1 | 🌐 Go | 📅 2026-08-02
...
### [⏫](#contents) Detect naked returns with [nakedret](https://github.com/alexkohler/nakedret) ⭐ 132 | 🐛 2 | 🌐 Go | 📅 2026-02-01
...
### [⏫](#contents) Detect mixing pointer and value method receivers with [smrcptr](https://github.com/nikolaydubina/smrcptr) ⭐ 13 | 🐛 4 | 🌐 Go | 📅 2026-08-02
...
### [⏫](#contents) Detect vertical function ordering with [vertfn](https://github.com/nikolaydubina/vertfn) ⚠️ Archived
...
### [⏫](#contents) Detect tests with wrong `t.Parallel()` usage with [paralleltest](https://github.com/kunwardeep/paralleltest) ⭐ 60 | 🐛 5 | 🌐 Go | 📅 2025-10-14
...
### [⏫](#contents) Detect tests with wrong `t.Parallel()` usage with [tparallel](https://github.com/moricho/tparallel) ⭐ 28 | 🐛 10 | 🌐 Go | 📅 2024-06-26
...
### [⏫](#contents) Detect magic numbers with [mnd](https://github.com/tommy-muehle/go-mnd) ⭐ 208 | 🐛 11 | 🌐 Go | 📅 2023-12-21
...
### [⏫](#contents) Detect bound checks with [pat/boundcheck](https://github.com/maruel/pat) ⭐ 11 | 🐛 0 | 🌐 Go | 📅 2023-08-29
...
### [⏫](#contents) :gift: Detect performance optimizations with [perfsprint](https://github.com/catenacyber/perfsprint) ⭐ 47 | 🐛 6 | 🌐 Go | 📅 2025-11-19
...
### [⏫](#contents) Calculate Cognitive Complexity with [gocognit](https://github.com/uudashr/gocognit) ⭐ 486 | 🐛 2 | 🌐 Go | 📅 2026-02-24
...
### [⏫](#contents) Calculate Cyclomatic Complexity with [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,593 | 🐛 11 | 🌐 Go | 📅 2025-12-27
...
### [⏫](#contents) Calculate Cyclomatic Complexity with [cyclop](https://github.com/bkielbasa/cyclop) ⭐ 56 | 🐛 1 | 🌐 Go | 📅 2024-10-16
...
### [⏫](#contents) Calculate age of comments with [go-commentage](https://github.com/nikolaydubina/go-commentage) ⚠️ Archived
...
### [⏫](#contents) Ensure `if` statements using short assignment with [ifshort](https://github.com/esimonov/ifshort) ⚠️ Archived
...
### [⏫](#contents) Detect sub-optimal struct layout with [betteralign](https://github.com/dkorunic/betteralign) ⭐ 1,075 | 🐛 0 | 🌐 Go | 📅 2026-08-14
...
### [⏫](#contents) Detect sub-optimal struct layout with [structlayout-optimize](https://github.com/dominikh/go-tools/blob/master/cmd/structlayout-optimize) ⭐ 6,849 | 🐛 575 | 🌐 Go | 📅 2026-06-30
...
### [⏫](#contents) Visualize struct layout with [structlayout](https://github.com/dominikh/go-tools/tree/master/cmd/structlayout) ⭐ 6,849 | 🐛 575 | 🌐 Go | 📅 2026-06-30
...
For compile time blocking of: accidental arithmetic; implicit cast of untyped constants; all operators except `==` and `!=`; — simply wrap into a struct in a separate package and do not export the field. [example](http://github.com/nikolaydubina/go-enum-example) ⭐ 11 | 🐛 0 | 🌐 Go | 📅 2024-05-09.
...
### [⏫](#contents) Analyze function callsites with [go-callsite-stats](https://github.com/nikolaydubina/go-callsite-stats) ⚠️ Archived
